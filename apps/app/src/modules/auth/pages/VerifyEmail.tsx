        ...
        <Card className="max-w-xl flex flex-col gap-2">
          ...
          <CardContent className="flex flex-col gap-8">
            <div className="flex flex-col gap-2 text-muted-foreground opacity-80">
              <p>Welcome to {config.app.name}! Please verify your email to activate your account.</p>
              <p>We've sent a verification email—check your inbox (or spam folder) and click the link to confirm.</p>
